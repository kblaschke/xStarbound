...
LuaCallbacks LuaBindings::makeInputCallbacks() {
  ...
  callbacks.registerCallback("key",     [input](String const& keyName) ->            bool { return input->keyHeld(KeyNames.getLeft(keyName)); });
  ...
  callbacks.registerCallback("mouse",     [input](String const& buttonName) ->               bool { return input->mouseHeld(MouseButtonNames.getLeft(buttonName)); });
